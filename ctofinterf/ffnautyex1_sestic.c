...
void ffnautyex1_sestic(int *coco, int connect[*coco][*coco], int flab[*coco], int color[*coco], int *hash_val1, int *hash_val2, int *hash_val3)
{
...
/*        printf("listhash\n"); */
        colorhash = listhash(color,n,489317L);
/*        printf("%lu \n",colorhash); */
